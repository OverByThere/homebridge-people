...
| `firewalled`               | optional, default: false, if set to true, it will check if the host is on the ARP table instead (see [74](https://github.com/PeteLawrence/homebridge-people/issues/74))                                                                                                                                                 |
